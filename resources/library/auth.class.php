	...
	*/
	...
	public function login($username, $password, $remember = 0)
	{
		...
		if ($validateUsername['error'] == 1) {
			...
			$return['message'] = "username_password_invalid1";
			return $return;
		} elseif($validatePassword['error'] == 1) {
			$this->addAttempt();
			
			$return['message'] = "username_password_invalid2";
			return $return;
		...
		setcookie($this->config->cookie_name, $sessiondata['hash'], $sessiondata['expiretime'], $this->config->cookie_path, $this->config->cookie_domain, $this->config->cookie_secure, $this->config->cookie_http);
